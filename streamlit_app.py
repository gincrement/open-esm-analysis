...
write("The whole analysis is available at OET's GitHub repository <a href='https://github.com/open-energy-transition/open-esm-analysis/'>open-esm-analysis</a>.")
write("<br/>")
write("<h2>Smarter Investments in Open Energy Planning: How Data Can Guide Decision-Makers</h2>")
write("<br/>")
...
write("<br/>")
write("But with an ever-growing number of open-source (OS) energy tools, the question remains: How do decision-makers—whether researchers, funders, or grid operators—select the right tools for their needs? The answer lies in data combined with experience.")
write("<br/>")
write("<h3>The Challenge: Identifying Reliable and Impactful Tools</h3>")
write("<br/>")
...
write ("<br/>")
write ("<h2>Key Takeaways from the Data</h2>")
write ("<ul>")
...
write ("</ul>")
write ("<br/>")
write ("<h2>Beyond Data: The Need for Qualitative Assessments</h2>")
write ("<br/>")
...
write ("<ul>")
write ("  <li><b>Documentation Quality</b>: Are installation and usage guides clear and up to date?</li>")
write ("  <li><b>Community Support</b>: Is there an active forum, mailing list, or issue tracker?</li>")
write ("  <li><b>Use Cases</b>: Has the tool been applied in real-world projects similar to your needs?</li>")
write ("  <li><b>Licensing & Governance</b>: Is it permissively licensed (e.g., MIT) or does it enforce restrictions (e.g., GPL)?</li>")
write ("  <li><b>Collaboration Potential</b>: Can multiple stakeholders contribute effectively?</li>")
write ("</ul>")
write ("<br/>")
write ("<h2>The Case for a Live Decision-Support Platform</h2>")
...
write ("<ul>")
write ("  <li><b>Maintenance health</b> (contributor activity, unresolved issues)</li>")
write ("  <li><b>Adoption rates</b> (downloads, citations, user engagement)</li>")
write ("  <li><b>Tool interoperability</b> (compatibility testing with other OS models)</li>")
write ("  <li><b>Funding needs</b> (identifying tools at risk due to lack of maintainers)</li>")
write ("</ul>")
write ("<br/>")
...
write ("<br/>")
write ("<h2>Conclusion</h2>")
write ("<br/>")
write ("Selecting the right OS energy planning tool is no longer just a technical choice — it’s an <b>investment decision</b>. While <b>data-driven insights can highlight adoption trends, sustainability risks, and tool maturity, <ins>qualitative assessments remain essential for selecting the best fit</ins></b>.")
write ("<br/>")
write ("<b>By combining live data tracking with structured qualitative evaluation</b>, the energy community can reduce wasted investments and ensure the best tools remain available for researchers, grid operators, project developers, investors and policymakers.")
write ("<br/>")
write ("<b>Would you find a real-time OS tool insight platform useful?</b> Share your thoughts and suggestions in the comments or the <a href='https://github.com/open-energy-transition/open-esm-analysis/issues'>issues tracker</a>!")
write ("<br/>")
